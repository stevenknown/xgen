int dgefa(double a[][201], int lda, int n, int ipvt[]);
void dgesl(double a[][201], int lda, int n, int ipvt[], double b[], int job);
void dmxpy(int n1, double y[], int n2, int ldm, double x[], double m[][21]);
...
double matgen(double m[][201], int lda, int n, double b[]);
double matgen(double a[][201], int lda, int n, double b[])
{
  double norma;
  int init, i, j;
...
void run_benchmark()
{
    ...
    */
    ...
    mflops_result = ops/(1000000*total);
    mflops_result += 0.0005; // for rounding
    mflops_result = (int)(mflops_result*1000);
    mflops_result /= 1000;

    printf("Mflops/s: %d, Time:%d, secs:%d, Precision:%d", mflops_result, time_result, residn_result, eps_result);
}
...
double epslon(double x)
{
  ...
  */
void dmxpy (int n1, double y[], int n2, int ldm, double x[], double m[][201])
{
  int j,i;
